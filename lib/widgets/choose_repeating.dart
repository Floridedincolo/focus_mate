...
const ChooseRepeating({super.key,required this.onRepeatChanged,required this.repeatType,required this.d});
  @override
...
class _ChooseRepeatingState extends State<ChooseRepeating> {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _repeatType==RepeatType.daily?Colors.blueAccent:Colors.transparent,
                      borderRadius: BorderRadius.circular(10),
                    ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      color: _repeatType==RepeatType.weekly?Colors.blueAccent:Colors.transparent,
                      borderRadius: BorderRadius.circular(10),
                    ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      color: _repeatType==RepeatType.custom?Colors.blueAccent:Colors.transparent,
                      borderRadius: BorderRadius.circular(10),
                    ),
    ...
    children:
     days.keys.map((day) {
       return FilterChip(
         label:Text(day.substring(0,3),style: const TextStyle(
           color: Colors.white,
           fontSize: 15.0,
         )),
         selected: days[day]!,
