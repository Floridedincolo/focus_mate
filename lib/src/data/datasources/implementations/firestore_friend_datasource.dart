...
/// - `friendships/{friendshipId}` — directed friendship links
///
...
class FirestoreFriendDataSource implements FriendDataSource {
  ...
  Stream<List<MeetingProposalDto>> watchMeetingProposals(String uid) {
    // Note: sorting is done client-side in the UI layer to avoid requiring
    // a composite Firestore index (array-contains + orderBy).
