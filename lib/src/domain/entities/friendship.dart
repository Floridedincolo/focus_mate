...
/// ```
/// friendships/
///   {friendshipId}/          ← auto-generated ID
///     requesterId: "uid_A"   ← who sent the request
///     receiverId:  "uid_B"   ← who received it
...
///
/// **Security Rules hint:**
/// - `create`: allowed when `request.auth.uid == requesterId`.
/// - `update`: allowed when `request.auth.uid == receiverId`
///   (only the `status` and `updatedAt` fields may change).
/// - `read`:   allowed when `request.auth.uid in [requesterId, receiverId]`.
class Friendship {
